<?php 
/* Template Name: Best 5 restaurants Page */
/**
						...
						<article class="hotel-highlights <?php echo $even_odd_class ?>">
							<div class="container">
								...
								<div class="hotel-gallery">
									...
									{
										$shortcode = '[' . 'gallery ids="' .$images_id. '" size="hotel-feaured"  rel="lightbox"]';
									}
...
<?php get_template_part( 'template-parts/content', 'more-info' ); ?>
